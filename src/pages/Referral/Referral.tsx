...
function Referral() {
  ...
  const handleFetchTreeSecondAndThird = async (id: number) => {
  ...
  return (
    <div id="treeWrapper" className={styles.referral}>
      ...
      <div className={styles.tree}>
        ...
        >
          {secondAndThird?.referal_1 && (
            <TreeNode
              label={
                <div
                  onClick={() => handleFetchTreeFourAndFive(secondAndThird?.referal1_id as number)}
                >
                  {secondAndThird?.referal_1.first_name} {secondAndThird?.referal_1.last_name}
                </div>
              }
            >
                          ...
                          {thirtyTwoAndThirtyThree?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyTwoAndThirtyThree.referal1_id)
                                  }
                                >
                          ...
                          {thirtyTwoAndThirtyThree?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyTwoAndThirtyThree.referal2_id)
                                  }
                                >
                          ...
                          {thirtyFourAndThirtyFive?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyFourAndThirtyFive.referal1_id)
                                  }
                                >
                          ...
                          {thirtyFourAndThirtyFive?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyFourAndThirtyFive.referal2_id)
                                  }
                                >
                          ...
                          {thirtySixAndThirtySeven?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtySixAndThirtySeven.referal1_id)
                                  }
                                >
                          ...
                          {thirtySixAndThirtySeven?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtySixAndThirtySeven.referal2_id)
                                  }
                                >
                          ...
                          {thirtyEightThirtyNine?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyEightThirtyNine.referal1_id)
                                  }
                                >
                          ...
                          {thirtyEightThirtyNine?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(thirtyEightThirtyNine.referal2_id)
                                  }
                                >
                          ...
                          {fourtyAndFourtyOne?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyAndFourtyOne.referal1_id)
                                  }
                                >
                          ...
                          {fourtyAndFourtyOne?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyAndFourtyOne.referal2_id)
                                  }
                                >
                          ...
                          {fourtyTwoAndFourtyThree?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyTwoAndFourtyThree.referal1_id)
                                  }
                                >
                          ...
                          {fourtyTwoAndFourtyThree?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyTwoAndFourtyThree.referal2_id)
                                  }
                                >
                          ...
                          {fourtyFourAndFourtyFive?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyFourAndFourtyFive.referal1_id)
                                  }
                                >
                          ...
                          {fourtyFourAndFourtyFive?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyFourAndFourtyFive.referal2_id)
                                  }
                                >
                          ...
                          {fourtySixAndFourtySeven?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtySixAndFourtySeven.referal1_id)
                                  }
                                >
                          ...
                          {fourtySixAndFourtySeven?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtySixAndFourtySeven.referal2_id)
                                  }
                                >
          ...
          {secondAndThird?.referal_2 && (
            <TreeNode
              label={
                <div onClick={() => handleFetchTreeSixAndSeven(secondAndThird.referal2_id)}>
                  {secondAndThird?.referal_2.first_name} {secondAndThird?.referal_2.last_name}
                </div>
              }
            >
                          ...
                          {fourtyEightAndFourtyNine?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyEightAndFourtyNine.referal1_id)
                                  }
                                >
                          ...
                          {fourtyEightAndFourtyNine?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fourtyEightAndFourtyNine.referal2_id)
                                  }
                                >
                        ...
                        >
                          {fiftyAndFiftyOne?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() => hanldeFetchLastTree(fiftyAndFiftyOne.referal1_id)}
                                >
                          ...
                          {fiftyAndFiftyOne?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() => hanldeFetchLastTree(fiftyAndFiftyOne.referal2_id)}
                                >
                          ...
                          {fiftyTwoAndFiftyThree?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyTwoAndFiftyThree.referal1_id)
                                  }
                                >
                          ...
                          {fiftyTwoAndFiftyThree?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyTwoAndFiftyThree.referal2_id)
                                  }
                                >
                          ...
                          {fiftyFourAndFiftyFive?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyFourAndFiftyFive.referal1_id)
                                  }
                                >
                          ...
                          {fiftyFourAndFiftyFive?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyFourAndFiftyFive.referal2_id)
                                  }
                                >
                          ...
                          {fiftySixAndFiftySeven?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftySixAndFiftySeven.referal1_id)
                                  }
                                >
                          ...
                          {fiftySixAndFiftySeven?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftySixAndFiftySeven.referal2_id)
                                  }
                                >
                          ...
                          {fiftyEightAndFiftyNine?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyEightAndFiftyNine.referal1_id)
                                  }
                                >
                          ...
                          {fiftyEightAndFiftyNine?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(fiftyEightAndFiftyNine.referal2_id)
                                  }
                                >
                        ...
                        >
                          {sixtyAndSixtyOne?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() => hanldeFetchLastTree(sixtyAndSixtyOne.referal1_id)}
                                >
                          ...
                          {sixtyAndSixtyOne?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() => hanldeFetchLastTree(sixtyAndSixtyOne.referal2_id)}
                                >
                          ...
                          {sixtyTwoAndSixtyThree?.referal_1 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(sixtyTwoAndSixtyThree.referal1_id)
                                  }
                                >
                          ...
                          {sixtyTwoAndSixtyThree?.referal_2 && (
                            <TreeNode
                              label={
                                <div
                                  onClick={() =>
                                    hanldeFetchLastTree(sixtyTwoAndSixtyThree.referal2_id)
                                  }
                                >
